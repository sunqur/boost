...
namespace ikiboyutluilkornek
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //{
            //    Console.WriteLine((i + 1) + ". Sırada ki markanın en çok satış yapılan miktarı : " + buyuk[i]);
            //}
            //for (int i = 0; i < 3; i++)
            //{
            //    Console.WriteLine((i + 1) + ". Sırada ki ayın en çok satış yapılan miktarı : " + byk[i]);
            //}
            ...
            string[] hdurum = new string[5];
            string[,] bilgiler = new string[30, 5];
            Random rnd = new Random();

            for (int i = 0; i < hdurum.Length; i++)
            {
            ...
            for (int i = 0; i < 30; i++)
            {
                for (int j = 0; j < 5; j++)
                {
                    bilgiler[i, j] = hdurum[rnd.Next(0,5)];
